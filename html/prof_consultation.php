...
$sql = "SELECT notation.id_note, notation.Type_Note, ue.Nom_UE, ressources.Nom_Res, etudiants.Prenom_Etu, etudiants.Nom_Etu, notation.Note, notation.Numero_Res, notation.Coefficient_Note, notation.Date
        FROM notation 
