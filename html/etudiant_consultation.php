...
<table>
    ...
    <tbody>
        ...
        if ($etudiant) {
            ...
            if (!empty($category)) {
                // Si le nom de l'UE est sélectionné
                ...
                // Si le nom de la ressource est sélectionné
                ...
                // Si le type de note est sélectionné
                ...
                // Si aucune catégorie n'est sélectionnée, récupérer toutes les notes de l'étudiant
