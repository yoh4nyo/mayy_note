...
$couleurAppreciation = ($moyenneGenerale > 10) ? 'green' : 'red';
$couleurValidation = ($moyenneGenerale > 10) ? 'green' : 'red';
?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <style>
        .appreciation { color: <?php echo $couleurAppreciation; ?>; }
        .validation { color: <?php echo $couleurValidation; ?>; }
    </style>
</head>
<body>
<header>
        ...
        <div class="content">
            ...
            <div class="right-content">
                <div class="appreciation">
                    <h3>Appréciation:</h3>
                    <p style="color: <?php echo $couleurAppreciation; ?>"><?php echo $appreciation; ?></p>
                </div>
                <div class="validation">
                    <h3>Validation du Semestre:</h3>
                    <p style="color: <?php echo $couleurValidation; ?>"><strong><?php echo $validationSemestre; ?></strong></p>
                </div>
            </div>
        </div>
    </div>
